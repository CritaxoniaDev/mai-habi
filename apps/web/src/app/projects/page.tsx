...
export const metadata: Metadata = {
  // This page defines its own full title rather than leaning on the layout's
  // title template.
      ...
      <header className="z-header sticky top-0 border-b border-border bg-background/80 backdrop-blur-md">
        <div className="mx-auto flex h-14 max-w-7xl items-center justify-between px-6">
          <a
            ...
            aria-label="HABI playground home"
          >
        ...
        <section className="flex flex-wrap items-end justify-between gap-x-8 gap-y-6 pt-14">
          <div className="max-w-2xl">
            ...
            <p className="mt-2 max-w-xl text-body font-light text-muted-foreground">
              Write HTML, CSS, JavaScript, React or Next.js in the browser —
              compiled on your machine and shared with a link.
            </p>
          </div>
          <DashboardActions />
        </section>
        ...
        <div className="mx-auto max-w-7xl px-6 py-12">
          ...
          <div className="mt-10 flex flex-wrap items-center justify-between gap-3 border-t border-border pt-6">
            <p className="text-label font-light text-muted-foreground">
              Projects are stored in this browser. Sign in only if you want them
              somewhere else.
            </p>
            <a
              href="/rest"
